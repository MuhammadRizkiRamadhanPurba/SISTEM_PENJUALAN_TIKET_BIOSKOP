...
// Mengambil data dari table tiket dari nim yang tidak sama dengan 0
$siswa = query("SELECT * FROM tiket WHERE nim = $nim")[0];
...
<body background="img/bg/bck.png">
     ...
     <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
          <div class="container">
               <a class="navbar-brand" href="index.php">PERUBAHAN DATA TIKET</a>
               ...
               <div class="col-md">
                    <form action="" method="post" enctype="multipart/form-data">
                         ...
                         <div class="mb-3">
                              ...
                              <select class="form-select w-50" id="film" name="film">
                                   <option disabled selected value>--------------------------------------------Pilih
                                        Film--------------------------------------------</option>
                                   <option value="GODZILLA" <?php if ($siswa['film'] == 'GODZILLA') { ?>
                                        selected='' <?php } ?>>GODZILLA</option>
                                   <option value="POKEMON"
                                        <?php if ($siswa['film'] == 'POKEMON') { ?> selected=''
                                        <?php } ?>>POKEMON</option>
                                   <option value="TENDANGAN SI MADUN" <?php if ($siswa['film'] == 'TENDANGAN SI MADUN') { ?>
                                        selected='' <?php } ?>>TENDANGAN SI MADUN</option>
                                   <option value="BOBOIBOY THE GALAXY"
                                        <?php if ($siswa['film'] == 'BOBOIBOY THE GALAXY') { ?> selected=''
                                        <?php } ?>>BOBOIBOY THE GALAXY</option>
                                   <option value="AGAK LAEN" <?php if ($siswa['film'] == 'AGAK LAEN') { ?>
                                        selected='' <?php } ?>>AGAK LAEN</option>
                                   <option value="TUKANG BUBUR NAIK PANGKAT" <?php if ($siswa['film'] == 'TUKANG BUBUR NAIK PANGKAT') { ?> selected=''
                                        <?php } ?>>TUKANG BUBUR NAIK PANGKAT</option>
                              </select>
                         </div>
                         <div class="mb-3">
     ...
     <div class="container-fluid">
          <div class="row bg-dark text-white text-center">
               <div class="col my-2" id="about">
                    <br><br><br>
                    <h4 class="fw-bold text-uppercase">CINEMATIX</h4>

                    <p>
                         Pembuat:
                         Muhammad Rizki Ramadhan Purba (12030122140290)
                    </p>
               </div>
          </div>
     </div>
     ...
     gsap.to('.ubah_data', {
          duration: 2,
          delay: 1,
          text: '<i class="bi bi-pencil-square"></i>Ubah Data Tiket'
     })
     gsap.from('.navbar', {
          duration: 1,
          y: '-100%',
