...
function tambah($data)
{
    ...
    $sql = "INSERT INTO siswa VALUES ('$nim','$nama','$tmpt_Lahir','$tgl_Lahir','$jekel','$film','$email','$gambar','$alamat')";
...
function ubah($data)
{
    ...
    $sql = "UPDATE siswa SET nama = '$nama', tmpt_Lahir = '$tmpt_Lahir', tgl_Lahir = '$tgl_Lahir', jekel = '$jekel', film = '$film', email = '$email', gambar = '$gambar', alamat = '$alamat' WHERE nim = $nim";
