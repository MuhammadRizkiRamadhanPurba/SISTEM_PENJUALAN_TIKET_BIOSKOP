...
if (isset($_POST['simpan'])) {
    if (tambah($_POST) > 0) {
        ...
        echo "<script>
                alert('Data Tiket gagal ditambahkan!');
            </script>";
    }
}
...
<body background="img/bg/tiketing.jpg">
     <!-- Navbar -->
     <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
          <div class="container">
               <a class="navbar-brand" href="index.php">Ayo Pesan Tiket Anda:)</a>
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                         ...
                         <div class="mb-3">
                              ...
                              <select class="form-select w-50" id="film" name="film">
                                   ...
                                   <option value="TENDANGAN SI MADUN">TENDANGAN SI MADUN</option>
                                   <option value="BOBOIBOY THE GALAXY">BOBOIBOY THE GALAXY</option>
                                   <option value="AGAK LAEN">AGAK LAEN</option>
                                   <option value="TUKANG BUBUR NAIK PANGKAT">TUKANG BUBUR NAIK PANGKAT</option>
                              </select>
                         </div>
                         <div class="mb-3">
     ...
     gsap.to('.Tambah_data', {
          duration: 2,
          delay: 1,
          text: '<i class="bi bi-person-plus-fill"></i>Tambah Tiket'
     })
     gsap.from('.navbar', {
          duration: 1,
          y: '-100%',
